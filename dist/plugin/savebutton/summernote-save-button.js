        ...
        var button = ui.button({
          ...
          click:function (e) {
            if (options.save.encode) {
              var noteText = $('.summernote').summernote('code');
              $('.summernote').summernote('code', escape(noteText));
              this.form.submit();
              $('.summernote').summernote('code', noteText);
            } else {
              //this.form.submit();
              localStorageTest(e);
            }
            console.log('estou em click');
            unsaved = false;
